...
export default function ArenaResponse({ solution1, solution2, judge_recommendation }) {
  useEffect(() => {
    hljs.highlightAll();
  }, [solution1, solution2]);
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center bg-white dark:bg-zinc-900 px-5 py-3 rounded-xl border border-zinc-100 dark:border-zinc-800">
                ...
                <span className="text-2xl font-bold text-emerald-600 dark:text-emerald-400">
                  {judge_recommendation.solution_1_score}/10
                </span>
              </div>
              <p className="text-zinc-600 dark:text-zinc-400 text-sm leading-relaxed px-2">
                {judge_recommendation.solution_1_reasoning}
              </p>
            </div>
            <div className="space-y-4">
              <div className="flex justify-between items-center bg-white dark:bg-zinc-900 px-5 py-3 rounded-xl border border-zinc-100 dark:border-zinc-800">
                ...
                <span className="text-2xl font-bold text-violet-600 dark:text-violet-400">
                  {judge_recommendation.solution_2_score}/10
                </span>
              </div>
              <p className="text-zinc-600 dark:text-zinc-400 text-sm leading-relaxed px-2">
                {judge_recommendation.solution_2_reasoning}
              </p>
            </div>
          </div>
        </div>
